		...
		<ul>
			...
			<img class="staff-member-photo" src="<?php
													if (file_exists($imageFilename)) {
														...
														echo 'https://digitalsignage.provo.edu/aux-tv//ajax/staff-images/placeholder.jpg';
													}
													?>"
			...
			<!--
					...
					<li class="vaultmessage"><?php if ($aDataTableDetailHTML[$staffCounter]['Message']) {
													echo 'Note: ' . $aDataTableDetailHTML[$staffCounter]['Message'];
												} ?></li>
					-->
			<!--
